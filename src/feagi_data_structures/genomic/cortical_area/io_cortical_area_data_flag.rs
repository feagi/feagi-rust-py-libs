...
use pyo3::prelude::*;
use feagi_data_structures::genomic::cortical_area::io_cortical_area_configuration_flag::{IOCorticalAreaConfigurationFlag, FrameChangeHandling, PercentageNeuronPositioning};
...
wrap_layered_enum!(PyIOCorticalAreaConfigurationFlag, IOCorticalAreaConfigurationFlag, "IOCorticalAreaConfigurationFlag");
...
impl PyIOCorticalAreaConfigurationFlag {
    ...
    #[staticmethod]
    pub fn Boolean() -> Self {
        PyIOCorticalAreaConfigurationFlag { inner: IOCorticalAreaConfigurationFlag::Boolean }
    }
    ...
    pub fn Percentage(frame_change_handling: PyFrameChangeHandling, percentage_neuron_positioning: PyPercentageNeuronPositioning) -> Self {
        PyIOCorticalAreaConfigurationFlag { 
            inner: IOCorticalAreaConfigurationFlag::Percentage(frame_change_handling.inner, percentage_neuron_positioning.inner) 
        }
    }
    ...
    pub fn Percentage2D(frame_change_handling: PyFrameChangeHandling, percentage_neuron_positioning: PyPercentageNeuronPositioning) -> Self {
        PyIOCorticalAreaConfigurationFlag { 
            inner: IOCorticalAreaConfigurationFlag::Percentage2D(frame_change_handling.inner, percentage_neuron_positioning.inner) 
        }
    }
    ...
    pub fn Percentage3D(frame_change_handling: PyFrameChangeHandling, percentage_neuron_positioning: PyPercentageNeuronPositioning) -> Self {
        PyIOCorticalAreaConfigurationFlag { 
            inner: IOCorticalAreaConfigurationFlag::Percentage3D(frame_change_handling.inner, percentage_neuron_positioning.inner) 
        }
    }
    ...
    pub fn Percentage4D(frame_change_handling: PyFrameChangeHandling, percentage_neuron_positioning: PyPercentageNeuronPositioning) -> Self {
        PyIOCorticalAreaConfigurationFlag { 
            inner: IOCorticalAreaConfigurationFlag::Percentage4D(frame_change_handling.inner, percentage_neuron_positioning.inner) 
        }
    }
    ...
    pub fn SignedPercentage(frame_change_handling: PyFrameChangeHandling, percentage_neuron_positioning: PyPercentageNeuronPositioning) -> Self {
        PyIOCorticalAreaConfigurationFlag { 
            inner: IOCorticalAreaConfigurationFlag::SignedPercentage(frame_change_handling.inner, percentage_neuron_positioning.inner) 
        }
    }
    ...
    pub fn SignedPercentage2D(frame_change_handling: PyFrameChangeHandling, percentage_neuron_positioning: PyPercentageNeuronPositioning) -> Self {
        PyIOCorticalAreaConfigurationFlag { 
            inner: IOCorticalAreaConfigurationFlag::SignedPercentage2D(frame_change_handling.inner, percentage_neuron_positioning.inner) 
        }
    }
    ...
    pub fn SignedPercentage3D(frame_change_handling: PyFrameChangeHandling, percentage_neuron_positioning: PyPercentageNeuronPositioning) -> Self {
        PyIOCorticalAreaConfigurationFlag { 
            inner: IOCorticalAreaConfigurationFlag::SignedPercentage3D(frame_change_handling.inner, percentage_neuron_positioning.inner) 
        }
    }
    ...
    pub fn SignedPercentage4D(frame_change_handling: PyFrameChangeHandling, percentage_neuron_positioning: PyPercentageNeuronPositioning) -> Self {
        PyIOCorticalAreaConfigurationFlag { 
            inner: IOCorticalAreaConfigurationFlag::SignedPercentage4D(frame_change_handling.inner, percentage_neuron_positioning.inner) 
        }
    }
    ...
    pub fn try_from_data_type_configuration_flag(flag: u16) -> PyResult<Self> {
        let data_flag = IOCorticalAreaConfigurationFlag::try_from_data_type_configuration_flag(flag)
